  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="relative w-full h-[600px] overflow-hidden">
        {featureImageList && featureImageList.length > 0
          ? featureImageList.map((slide, index) => (
              <img
                ...
                } absolute top-0 left-0 w-screen h-screen object-cover transition-opacity duration-1000`}
              />
            ))
          : null}
        <Button
          className="absolute top-1/2 left-4 transform translate-y-1 bg-white/80"
          variant="outline"
          size="icon"
          onClick={() =>
            setCurrentSlide(
        ...
        <Button
          className="absolute top-1/2 right-4 transform translate-y-1 bg-white/80"
          variant="outline"
          size="icon"
          onClick={() =>
